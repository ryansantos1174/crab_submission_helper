...
class TestGoogleSheetHelpers(unittest.TestCase):
    ...
    @patch("your_module_name.Credentials")
    @patch("your_module_name.gspread")
    ...
    def test_find_worksheet_found(self):
        ...
        mock_sheet.worksheets.return_value = [
            MagicMock(title="2023Av1"),
            MagicMock(title="2024Bv2"),
        ]
        # fix the bug: function uses `sh.worksheets()` but should use `sheet`
        result = find_worksheet(mock_sheet, "2023A", "v1")
    ...
    def test_find_worksheet_not_found(self):
        ...
        result = find_worksheet(mock_sheet, "2022", "v3")
    ...
    @patch("your_module_name.logging")
    ...
    @patch("your_module_name.parse_crab_task")
    @patch("your_module_name.setup_google_sheet")
    @patch("your_module_name.find_worksheet")
    @patch("your_module_name.find_cell")
    @patch("your_module_name.edit_cell")
    def test_update_task_status(
        ...
        mock_parse.return_value = ("sel", "2023A", "v1", "v0")
